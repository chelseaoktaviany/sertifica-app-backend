...
const handleDuplicateFieldsDB = (err) => {
  ...
  const msg = `User dengan alamat e-mail ${value} sudah pernah ada.`;
...
const handleJWTExpiredError = () =>
  new AppError('Token Anda telah kedaluarsa! Mohon lakukan login lagi.', 401);
...
const sendErrorProd = (err, req, res) => {
  ...
  if (req.originalUrl.startsWith('/v1')) {
    ...
    return res.status(500).json({
      status: 2,
      msg: 'Ada kesalahan yang terjadi!',
    });
  }
